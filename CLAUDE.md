...
> Based on [SamurAIGPT/llm-wiki-agent](https://github.com/SamurAIGPT/llm-wiki-agent), implementing [Karpathy's LLM Wiki pattern](https://gist.github.com/karpathy/442a6bf555914893e9891c11519de94f).
...
A personal learning knowledge base. Drop notes, code snippets, articles, and study materials into `raw/` and the LLM compiles them into an interlinked wiki that grows smarter over time.
